...
/**
 * We will retrieve the tenantid request attribute from Spring MVC RequestContextHolder and provide it to Hibernate
 * (this is the tenantid we added in our interceptor).
 *
